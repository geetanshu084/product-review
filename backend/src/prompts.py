...
class Prompts:
    ...
    def get_structured_extraction_prompt() -> str:
        """Prompt template for structured data extraction in ProductOrchestrator"""
        return PromptLoader.load_prompt("structured_extraction_prompt.txt")
    ...
    @staticmethod
    def get_web_search_summary_prompt(content: str) -> str:
        """
        ...
        Returns:
            Formatted prompt
        """
        template = PromptLoader.load_prompt("web_search_summary_prompt.txt")
...
def get_structured_extraction_prompt() -> str:
    ...
    return Prompts.get_structured_extraction_prompt()
...
def get_web_search_summary_prompt(content: str) -> str:
    """Get web search summary prompt"""
    return Prompts.get_web_search_summary_prompt(content)
